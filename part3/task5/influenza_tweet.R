...
#Searching for tweets related to influenza
tweets<-searchTwitter("influenza",n=10000)
...
write.csv(twdf,"/Users/apple/Desktop/DIC lab 1/part3/task5/FinaltweetsSneeze.csv")
write.csv(temp,"/Users/apple/Desktop/DIC lab 1/part3/task5/userdataSneeze.csv")

#Run below commands to replicate the influenza tweet distribution graph
twdf<-read.csv("/Users/apple/Desktop/DIC lab 1/part3/task5/FinaltweetsSneeze.csv")
temp<-read.csv("/Users/apple/Desktop/DIC lab 1/part3/task5/userdataSneeze.csv")
library(sp)
library(maps)
library(maptools)
temp<-temp[temp[4]<0,]
...
P1 <- p + theme_bw()  + labs(fill = "Frequency of Tweets" 
                             ,title = "                      2019 Influenza Tweet Distribution",x="", y="")
